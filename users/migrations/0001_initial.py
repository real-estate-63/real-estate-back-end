# Generated by Django 3.2.12 on 2022-05-31 08:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='address',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='address_profile', to='users.userprofile'),
        ),
        migrations.AddField(
            model_name='address',
            name='province_city',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='systems.provincecity'),
        ),
        migrations.AddField(
            model_name='address',
            name='user',
        ...
        migrations.AddField(
            model_name='address',
            name='ward',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='systems.ward'),
        ),
    ]
